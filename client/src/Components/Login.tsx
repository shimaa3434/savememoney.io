    ...
    return (
        <div className='w-screen flex flex-col items-center'>
            <form className='w-screen flex flex-col items-center py-10' onSubmit={(event:any) => {event.preventDefault();}}>
                ...
                <button className='ring-4 ring-blue-200 text-white text-xl bg-blue-800 px-4 py-4 w-2/5 rounded-full md:w-1/5' type='submit' onClick={(event:any) => {if (PASSWORD !== '' && USEROREMAIL !== '') LoginUser(USEROREMAIL, PASSWORD);}}>LOGIN</button>
